<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditarAprobador.aspx.cs" Inherits="LMD.Catalogos.EditarAprobador" %>
     ...
     <div class="divRedondo">
        <div class="row">
            ...
            <div class="col-md-12 col-xs-12 col-sm-12">
                <center>
                        <asp:Label ID="lblEditarAprobador" runat="server" Text="Editar Aprobador" Font-Size="Large" ForeColor="Black"></asp:Label>
                    </center>
            </div>
            <%-- fin titulo accion --%>
