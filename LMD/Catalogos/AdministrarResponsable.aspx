<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdministrarResponsable.aspx.cs" Inherits="LMD.Catalogos.AdministrarResponsable" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-xs-12 col-sm-12">
                <center>
            <asp:Label ID="lblAdministrarResponsables" runat="server" Text="Administrar Responsables" Font-Size="Large" ForeColor="Black"></asp:Label>
        </center>
            </div>
            <%-- fin titulo pantalla --%>
            ...
            <div class="col-md-12 col-xs-12 col-sm-12" style="text-align: center; overflow-y: auto;">
                ...
                <asp:Repeater ID="rpResponsable" runat="server" OnItemDataBound="rpResponsable_ItemDataBound">
                    <HeaderTemplate>
                        <table id="tblResponsable" class="row-border table-striped">
                            <thead>
                                <tr>
                                    <th></th>
                                    <th>Nombre</th>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ScriptContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        $('#tblResponsable thead tr#filterrow th').each(function () {
            var campoBusqueda = $('#tblResponsable thead th').eq($(this).index()).text();
            $(this).html('<input type="text" style="text-align: center" onclick="stopPropagation(event);" placeholder="Buscar ' + campoBusqueda + '" />');
        });

        // DataTable
        var table = $('#tblResponsable').DataTable({
            orderCellsTop: true,
            "iDisplayLength": 10,
        ...
        // aplicar filtro
        $("#tblResponsable thead input").on('keyup change', function () {
            table
